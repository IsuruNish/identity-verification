...
/**
 * A JSONPatch as defined by RFC 6902. Patch operation is supported only for root level attributes of an identity verificationprovider.
 **/

import java.util.Objects;
import javax.validation.Valid;
import javax.xml.bind.annotation.*;
@ApiModel(description = "A JSONPatch as defined by RFC 6902. Patch operation is supported only for root level attributes of an identity verificationprovider.")
public class Patch  {
...
public enum OperationEnum {
    ...
    **/
    ...
    @ApiModelProperty(example = "displayName", required = true, value = "A JSON-Pointer")
    @JsonProperty("path")
    @Valid
    ...
    **/
    ...
    @ApiModelProperty(example = "EVIDENTID", value = "The value to be used within the operations.")
    @JsonProperty("value")
    @Valid
