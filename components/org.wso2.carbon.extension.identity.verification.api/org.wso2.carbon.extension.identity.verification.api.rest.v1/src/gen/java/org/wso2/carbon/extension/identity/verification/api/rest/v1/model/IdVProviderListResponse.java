...
public class IdVProviderListResponse  {
    ...
    private List<IdentityVerificationProvider> identityVerificationProviders = null;
    ...
    **/
    ...
    /**
    **/
    public IdVProviderListResponse identityVerificationProviders(List<IdentityVerificationProvider> identityVerificationProviders) {
    ...
    @Valid
    public List<IdentityVerificationProvider> getIdentityVerificationProviders() {
        return identityVerificationProviders;
    }
    public void setIdentityVerificationProviders(List<IdentityVerificationProvider> identityVerificationProviders) {
        this.identityVerificationProviders = identityVerificationProviders;
    }

    public IdVProviderListResponse addIdentityVerificationProvidersItem(IdentityVerificationProvider identityVerificationProvidersItem) {
