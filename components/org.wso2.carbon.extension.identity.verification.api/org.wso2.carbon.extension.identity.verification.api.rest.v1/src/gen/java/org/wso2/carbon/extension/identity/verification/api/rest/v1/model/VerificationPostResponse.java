...
public class VerificationPostResponse  {
    ...
    private List<Verifiedattributes> claims = null;
    ...
    **/
    ...
    /**
    **/
    public VerificationPostResponse claims(List<Verifiedattributes> claims) {
    ...
    @JsonProperty("claims")
    @Valid
    public List<Verifiedattributes> getClaims() {
        return claims;
    }
    public void setClaims(List<Verifiedattributes> claims) {
        this.claims = claims;
    }

    public VerificationPostResponse addClaimsItem(Verifiedattributes claimsItem) {
        if (this.claims == null) {
